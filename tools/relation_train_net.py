...
def train(cfg, local_rank, distributed, logger):
    ...
    if checkpointer.has_checkpoint():
        extra_checkpoint_data = checkpointer.load(pretrain_object_detector_dir, update_schedule=cfg.SOLVER.UPDATE_SCHEDULE_DURING_LOAD, with_optim=True)
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        if cfg.SOLVER.TO_VAL and iteration % cfg.SOLVER.VAL_PERIOD == 0:
            ...
            if val_result > best_mR:
                ...
                best_mR = val_result
            logger.info("now best epoch in R@k is : %d, num is %.4f" % (best_epoch, best_mR))
