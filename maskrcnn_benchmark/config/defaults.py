...
_C.MODEL.PRETRAINED_DETECTOR_CKPT = "../../pretrained_ckpt/model_final.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT_GQA = "../../pretrained_ckpt/gqa_model_final_from_vg.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT_OIV6 = "../../pretrained_ckpt/oiv6_det.pth"
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.DATASETS.TEST = ()
_C.DATASETS.TO_TEST = 'train'

_C.DATASETS.GQA_200_TRAIN = ()
_C.DATASETS.GQA_200_VAL = ()
_C.DATASETS.GQA_200_TEST = ()

_C.DATASETS.OIV6_TRAIN = ()
_C.DATASETS.OIV6_VAL = ()
_C.DATASETS.OIV6_TEST = ()
...
_C.MODEL.ROI_BOX_HEAD.OIV6_NUM_CLASSES = 602
...
_C.MODEL.ROI_RELATION_HEAD.OIV6_NUM_CLASSES = 31
...
# This is global, so if we have 8 GPUs and IMS_PER_BATCH = 16, each GPU will
# see 2 images per batch
_C.TEST.IMS_PER_BATCH = 2  # TRAIN_INFER: 4
...
_C.GLOBAL_SETTING.RELATION_PREDICTOR = 'PrototypeEmbeddingNetwork'
_C.GLOBAL_SETTING.CHOOSE_BEST_MODEL_BY_METRIC = '_mean_recall'

_C.MODEL.USE_REWEIGHT = 'HTCL' # or PENET, loss.py
_C.MODEL.NUM_BETA = 0.9999
_C.MODEL.CUT_RELS = 200
_C.MODEL.TRAIN_INFER = False # True only for calculating variation of each predicate class
