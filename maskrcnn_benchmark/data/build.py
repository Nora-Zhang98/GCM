...
def get_dataset_statistics(cfg):
    ...
    if cfg.GLOBAL_SETTING.DATASET_CHOICE == 'VG':
        ...
        dataset_names = cfg.DATASETS.OIV6_TRAIN
    else:
        dataset_names = None
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0, dataset_to_test=None):
    ...
    is_train = mode == 'train'
    # is_train = True # 计算FLOPs
    if cfg.MODEL.TRAIN_INFER:
        is_train = False
    if is_train:
    ...
    if cfg.GLOBAL_SETTING.DATASET_CHOICE == 'VG':
        ...
        if mode == 'train':
            dataset_list = cfg.DATASETS.OIV6_TRAIN
        elif mode == 'val':
            dataset_list = cfg.DATASETS.OIV6_VAL
        else:
            dataset_list = cfg.DATASETS.OIV6_TEST
    else:
        dataset_list = None
